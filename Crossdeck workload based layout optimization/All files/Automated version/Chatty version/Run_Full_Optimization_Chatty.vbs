...
'   Version: 2.2 (Chatty Version with Corrected Progress Indicators)
'
'=======================================================================================
Option Explicit
...
'=======================================================================================
WScript.Echo "--- PHASE 1: STARTING ---" & vbCrLf
WScript.Echo "NOTE: Step 2 (Manual Data Prep in Data_CD.xlsm) is assumed to be complete." & vbCrLf

' --- Step 1: Export from Visio ---
WScript.Echo "Step 1/12: Exporting default layout from Visio..."
...
excelApp.Run "'" & excelWb.Name & "'!ImportWorkloadAndBufferData"
excelWb.Close True
Set excelWb = Nothing
...
excelApp.Run "'" & excelWb.Name & "'!UpdateFromInputData"

' --- Step 5: Run First Cycle Optimization ---
WScript.Echo "Step 4/12: Running First Cycle placement optimization..."
excelApp.Run "'" & excelWb.Name & "'!RunFirstCycle_Placement"

' --- Step 6: Generate All Matrices for Analysis ---
WScript.Echo "Step 5/12: Generating all four distance matrices..."
excelApp.Run "'" & excelWb.Name & "'!GenerateAllMatrices"

' --- Step 7: Export Matrix for Simulation ---
WScript.Echo "Step 6/12: Exporting distance matrix for simulation..."
excelApp.Run "'" & excelWb.Name & "'!ExportMatrixForSimulation"
excelWb.Close True
Set excelWb = Nothing
excelApp.Quit
...
WScript.Echo "Step 8/12: Recalculating area widths..."
excelApp.Run "'" & excelWb.Name & "'!RecalculateAreaWidths"
excelWb.Close True
Set excelWb = Nothing
...
excelApp.Run "'" & excelWb.Name & "'!RunSecondCycle_Placement"

' --- Step 12: Run Final Analysis ---
WScript.Echo "Step 11/12: Running final cost analysis..."
excelApp.Run "'" & excelWb.Name & "'!RunFinalAnalysis"
excelWb.Close True
Set excelWb = Nothing
excelApp.Quit
Set excelApp = Nothing
...
WScript.Echo "Step 12/12: Drawing final optimized layout in Visio..."
Set visioApp = CreateObject("Visio.Application")
...
MsgBox "Automation Complete!" & vbCrLf & vbCrLf & "The final optimized layout has been generated in Visio, and all analysis reports have been updated.", vbInformation, "Crossdock Optimization"
