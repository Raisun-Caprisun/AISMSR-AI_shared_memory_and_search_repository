Attribute VB_Name = "MatrixDefaultEuclidian"
'---------------------------------------------------------------------------------------
' Module: MatrixGeneratorDefault_EUC
' Version: 1.0
' Popis: Vytvoøí Euklidovskou matici vzdáleností z PÙVODNÍCH souøadnic na 4. listu.
'---------------------------------------------------------------------------------------
Option Explicit
...
Public Sub GenerateDefaultMatrix_Euclidean()
    ...
    ' Cílení na ètvrtý list
    Do While ThisWorkbook.Worksheets.count < 4
        ThisWorkbook.Worksheets.Add After:=ThisWorkbook.Worksheets(ThisWorkbook.Worksheets.count)
    Loop
    Set matrixSheet = ThisWorkbook.Worksheets(4)
    On Error GoTo 0
    
    matrixSheet.Name = "Matrix_Euclidean_Default"
    ...
    For i = 1 To sortedObjects.count
        ...
        For j = 1 To sortedObjects.count
            ...
            distance = Sqr((x2 - x1) ^ 2 + (y2 - y1) ^ 2) ' Euclidean
...
Cleanup:
    ...
    MsgBox "Euklidovská matice PÙVODNÍHO layoutu byla úspìšnì vytvoøena.", vbInformation
End Sub
